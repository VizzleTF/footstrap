...
cascade layer; cascade.css is generated by build-css.sh and not read here — docs/17).
...
def audit_base_dead(css):
    ...
    CLAUDE.md. So only an all-repainted group is reported as removable; a mixed one is
